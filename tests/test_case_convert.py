...
class TestCaseConversion(unittest.TestCase):
    ...
    def test_snake2camelcase_complex_cases(self):
        # Complex and mixed cases
        assert snake2camelcase("snake_case_with__double_underscore") == "snakeCaseWithDoubleUnderscore"
        assert snake2camelcase("camel_case_with_123_numbers") == "camelCaseWith123Numbers"
        assert snake2camelcase("test_value_another_test") == "testValueAnotherTest"
        assert snake2camelcase("snake_case_with__leading_and_trailing_underscores_") == "snakeCaseWithLeadingAndTrailingUnderscores"
